...
public class Practica2SI {
	...
	long t1 = System.currentTimeMillis();
        ...
        //ClasificadorDebil cd = new ClasificadorDebil(NUM_ITERACIONES, minPoints, maxPoints);
        //cd.aprendizaje(listaAprendizaje);
	...
	//Test final
        if(VERBOSE)
        {
            ...
            {
                //clase = cd.ubicacionPunto(cd.getmejorHiperplano(), c);
